...
class HomeDetailPage extends StatelessWidget {
  ...
  const HomeDetailPage({
    Key? key,
    required this.catalog, // Use 'required' keyword, null safety compliant
  }) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: VxArc(
                height: 30.0,
                arcType: VxArcType.convex, // fixed enum name, lowercase 'convex'
                edge: VxEdge.top,           // fixed enum name, lowercase 'top'
                child: Container(
                  color: context.cardColor,
                  ...
                  child: Column(
                    ...
                    children: [
                      catalog.name.text
                          .xl4
                          .color(context.theme.colorScheme.secondary) // updated color accessor
                          .bold
                          .make(),
                      catalog.desc.text
